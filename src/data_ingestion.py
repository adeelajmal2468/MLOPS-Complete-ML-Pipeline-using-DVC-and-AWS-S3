...
logger = logging.getLogger('data_ingestion') # Create Logger Object
logger.setLevel('DEBUG') # Logger Level set to debug
...
file_handler.setLevel('DEBUG') # set file handler to debug level
